...
<ul class="nav nav-tabs" role="tablist" style="margin-bottom: 15px;">
    ...
    <li class="nav-item">
        <a class="nav-link" onclick="listeManager()" href="#listeManager" data-toggle="tab">
            <i class="fas fa-tasks"></i> {{ __("Dosya Liste") }}
        </a>
    </li>
</ul>
...
<div class="tab-content">
    ...
    <div id="listeManager" class="tab-pane">
        @include('dosyaListe.main')
    </div>
</div>
@endsection